...
@section('title','Acessory')
@section('myContent')

<div class="container-fluid" style=" padding-top:90px;">
    <div class="row d-flex justify-content-center mb-4">
        <div class=" form-control text-center h-50 align-self-center" style="width: 300px">
            <form action="{{route('user#search',['table'=>'accessory'])}}" method="GET">
                @csrf
                <button class=" border-0" for="search"><i class="fa-solid fa-magnifying-glass hover"></i></button>
                <input type="text" name="search" id="search" class=" ps-1" style="border: none;width:250px;" placeholder="  Search Accessory  ">
            </form>
        </div>
    </div>
    <div class="row">
