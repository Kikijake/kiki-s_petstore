...
@section('content')
    <div class=" container-fluid mb-5">
        <div class="row">
            <form action="{{route('admin#updateItem#Food',['id' => $data->id])}}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class=" offset-2 col-4">
                            ...
                            <div class="row" style="padding-top: 160px">
                                <a href="{{route('admin#food',$data->type)}}" class=" col btn btn-danger hover m-2">Cancel</a>
